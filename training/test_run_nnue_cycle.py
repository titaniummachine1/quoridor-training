...
from training import run_nnue_cycle
...
class RunNnueCycleTests(unittest.TestCase):
    ...
    def test_catch_up_stops_before_skipping_failed_row(self, _pending, run_game, _log):
        with patch("training.nnue_guards.load_guard_state", return_value={"last_trained_game_id": 9}):
    ...
    def test_dry_run_does_not_advance_cursor(
        ...
        with patch("training.nnue_guards.load_guard_state", return_value={"games_trained": 1}):
