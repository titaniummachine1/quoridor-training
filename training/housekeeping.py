...
def run_pool_housekeeping(*, reset_pool_counter: bool = True) -> list[str]:
    ...
    from datagen import DB_PATH, backfill_moves_bin, compact_moves_text, count_pool_games
    from manifest import load_manifest, matchup_key, save_manifest
    from swiss_tournament import all_pairings
