...
LEGACY_REFERENCE_ALLOW_PREFIXES = (
    "training/titanium_training/store",
    "training/titanium_training/store_friend",
    "training/tests/test_position_store",
    "training/CANONICAL_DATASTORE",
    "training/POSITION_STORE_RUNBOOK",
    "training/data/archive/",
    "training/data/position_store_reports/",
    "training/experiments/lmr/collect_search_importance",
    "training/experiments/lmr/collect_reduction",
    "training/zero_teacher/collect",
    "training/zero_teacher/HANDOFF",
    "training/experiments/lmr/run_search_pressure_experiment",
    "training/tools/operations/coordinator",
    "training/tools/datagen",
    "training/tools/datagen/ingest_self_match",
    "training/tools/datagen/import_clipboard",
    "training/tools/maintenance/verify_db_games",
    "training/tools/maintenance/ka_api_teacher",
    "docs/decisions",
    "training/tools/scripts/watch_progress",
    "training/experiments/lmr/train_search_importance",
)

CANONICAL_EXPORT_COMMAND = (
    "python training/titanium_training/store.py export-game-training "
    "training/data/exports/game_training_export.jsonl"
)
TEACHER_EXPORT_COMMAND = (
    "python training/titanium_training/store.py export-teacher-training "
    "training/data/exports/teacher_training_export.jsonl --include-teacher-labels"
)
MIXED_EXPORT_COMMAND = (
    "python training/titanium_training/store.py export-mixed-training "
