...
from titanium_training.store.guards import assert_canonical_training_db, is_smoke_database
...
from titanium_training.store.compact import (
...
from titanium_training.store.friend import (
...
from titanium_training.store.teacher import (
    audit_game_store,
    audit_teacher_store,
...
from titanium_training.store.migration import (
...
from titanium_training.store.split import run_split_migration
...
def command_migrate_production(args: argparse.Namespace) -> int:
    if args.dry_run_only:
        ...
        from titanium_training.store.migration import run_dry_migration
