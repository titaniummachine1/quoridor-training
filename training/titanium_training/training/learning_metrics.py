...
def _ka_pool_stats() -> dict:
    from tools.maintenance.manifest import CURRENT_ENGINE, load_manifest
...
def collect_learning_report(*, write_json: bool = True) -> dict:
    from tools.datagen.datagen import DB_PATH, max_game_id, untrained_game_ids
    from titanium_training.training.guards import DEPLOY_EVERY_GAMES, load_guard_state
    from titanium_training.training.plateau_probe import (
        PROBE_PATH,
