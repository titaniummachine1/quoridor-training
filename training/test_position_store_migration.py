...
from position_store_config import CANONICAL_DB, DATA_DIR, LEGACY_GAME_DB
from position_store_guards import LegacyTrainingSourceError, assert_canonical_training_db, is_smoke_database
from position_store_lib import init_db, insert_game, semantic_checksum
from position_store_migration import audit_legacy_references, full_artifact_inventory, resolve_import_paths
...
def test_resolve_import_paths_includes_core_sources() -> None:
    ...
    assert "training/data/all_games.db" in rels
